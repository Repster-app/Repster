...
struct ExportView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Text("The backup file is Repster-specific and meant for full restore, not third-party CSV import.")
                .font(.caption)
...
struct RestoreBackupView: View {
    ...
    var body: some View {
        ...
        .fileImporter(
            ...
            allowedContentTypes: UTType.workoutHistoryBackupImportTypes
        ) { result in
...
extension UTType {
    static let repsterWorkoutHistoryBackup = UTType(exportedAs: "com.magnusespensen.repster.workout-history", conformingTo: .json)
    static let legacyReppoWorkoutHistoryBackup = UTType(importedAs: "com.magnusespensen.reppo.workout-history", conformingTo: .json)
    static let workoutHistoryBackupImportTypes: [UTType] = [
        .repsterWorkoutHistoryBackup,
        .legacyReppoWorkoutHistoryBackup,
    ]
}
